  ...
  $custom_settings = array(
	...
	*/
    'sections'        => array(
      ...
      array(
        'title'       => __( 'Layout', ktz_theme_textdomain ),
        'id'          => 'layout_tab'
      ),
      array(
      ...
      array(
        'title'       => __( 'Sidebars', ktz_theme_textdomain ),
        'id'          => 'sidebars_tab'
      ),
      array(
	...
	*/
      ...
      array(
        ...
        'type'        => 'textarea-simple',
        'desc'        => __( 'Fill with banner 728x90 header banner.', ktz_theme_textdomain ),
        'std'         => '<a href="http://www.askhomedesign.com" title="banner 728x90"><img src="https://farm3.staticflickr.com/2929/14681915121_191f465cf5_b.jpg" alt="banner 728x90" title="banner 728x90" height="90" width="728" /></a>',
        'rows'        => '5',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
      ...
      array(
        'label'       => __( 'Enable Single Header banner (336x280)?', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_shead_activated',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for enable Single Header banner (336x280) and check no for disable Single Header banner (336x280).', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        'label'       => __( 'Single Header banner (336x280)', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_shead',
        'type'        => 'textarea-simple',
        'desc'        => __( 'Fill with header banner 336x280 in single before title', ktz_theme_textdomain ),
        'std'         => '<a href="http://www.askhomedesign.com/" title="Best wordpress themes"><img src="https://farm4.staticflickr.com/3892/14681915171_bf8a910b6b_o.png" alt="banner 300x280" width="336" height="280" title="banner 336x280" /></a>',
        'rows'        => '5',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
		'condition'   => 'ktz_ban46860_shead_activated:is(yes),ktz_ban46860_shead_activated:not()',
        'section'     => 'banner_tab'
      ),
      array(
        'label'       => __( 'Enable Single After title banner (336x280)?', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_stit_activated',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for enable Single After title banner (336x280) and check no for disable Single After title banner (336x280).', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        'label'       => __( 'Single After title banner (336x280)', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_stit',
        'type'        => 'textarea-simple',
        'desc'        => __( 'Fill with after title banner 336x280 in single', ktz_theme_textdomain ),
        'std'         => '<a href="http://www.askhomedesign.com/" title="Best wordpress themes"><img src="https://farm4.staticflickr.com/3892/14681915171_bf8a910b6b_o.png" alt="banner 300x280" width="336" height="280" title="banner 336x280" /></a>',
        'rows'        => '5',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
        'label'       => __( 'Enable Single Footer banner (336x280)?', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_sfot_activated',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for enable Single Footer banner (336x280) and check no for disable Single Footer banner (336x280).', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        'label'       => __( 'Single Footer banner (336x280)', ktz_theme_textdomain ),
        'id'          => 'ktz_ban46860_sfot',
        'type'        => 'textarea-simple',
        'desc'        => __( 'Fill with bottom banner 336x280 in single after post', ktz_theme_textdomain ),
        'std'         => '<a href="http://www.askhomedesign.com/" title="Best wordpress themes"><img src="https://farm4.staticflickr.com/3892/14681915171_bf8a910b6b_o.png" alt="banner 300x280" width="336" height="280" title="banner 336x280" /></a>',
        'rows'        => '5',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
        ...
        'std'         => '<a href="#" title="example banner link"><img src="https://farm6.staticflickr.com/5572/14681915051_0bf4684147_o.png" alt="example banner" title="example banner" height="600" width="160"></a>',
        'rows'        => '5',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
	...
	*/
      array(
        'label'       => __( 'General Layout', ktz_theme_textdomain ),
        'id'          => 'ktz_gen_layout',
        'type'        => 'radio-image',
        'desc'        => __( 'Select layout for your global website.', ktz_theme_textdomain ),
		'choices'     => layout_select(),
        'std'         => 'box',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
        'label'       => __( 'Content Layout', ktz_theme_textdomain ),
        'id'          => 'ktz_content_layout',
        'type'        => 'radio-image',
        'desc'        => __( 'Select layout for your content in archive.', ktz_theme_textdomain ),
		'choices'     => contentlay_select(),
        'std'         => 'layout_gallery',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
        ...
        'id'          => 'ktz_sb_layout',
        'type'        => 'radio-image',
        'desc'        => __( 'Select default sidebar for your global website.', ktz_theme_textdomain ),
	...
	*/
	  ...
	  array(
		'label'       => __( 'CSS File', ktz_theme_textdomain ),
		'id'          => 'ktz_styledefault',
		'type'        => 'select',
		'desc'        => __( 'If your modified your own css in custom.css file in includes/assets/css/custom.css. Of if you have own css file for example style-1.css, upload it in folder includes/assets/css/ so this option will auto detect your css file, after that select file and save changes.', ktz_theme_textdomain ),
		'choices'     => autostylish_select(),
		'std'         => '',
		'rows'        => '',
		'post_type'   => '',
		'taxonomy'    => '',
	...
	*/
	  array(
		...
		'settings'    => array(
			...
			'id'          => 'color',
			'type'        => 'colorpicker',
			'desc'        => __( 'Pick a category color(default: #d64a2b ).', ktz_theme_textdomain ),
			'std'         => '#d64a2b',
			'rows'        => '',
			'post_type'   => '',
			'taxonomy'    => '',
			...
			'std'         => 'glyphicon glyphicon-transfer',
			'rows'        => '',
			'post_type'   => '',
			'taxonomy'    => '',
			'class'       => '',
	...
	*/
      ...
      array(
        'label'       => __( 'Google API Key', ktz_theme_textdomain ),
        'id'          => 'ktz_googleapi_key',
        'type'        => 'text',
        'desc'       => __( 'Fill with your google API Key. Please signuo https://developers.google.com/loader/signup first for get your google API Key.', ktz_theme_textdomain ),
        'std'         => '',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
        ...
        'id'          => 'ktz_bad_keyword',
        'type'        => 'textarea-simple',
        'desc'       => __( 'Please filter your bad keyword from your AGC.', ktz_theme_textdomain ),
	...
	*/
      array(
        'label'       => __( 'Enable download image button in single?', ktz_theme_textdomain ),
        'id'          => 'ktz_active_download',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for Enable download image button in single and attachment and check no for disable auto disable download image button in single and attachment.', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        'label'       => __( 'Enable auto description?', ktz_theme_textdomain ),
        'id'          => 'ktz_active_autocontent',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for enable auto description in single and attachment and check no for disable auto description in single and attachment.', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        'label'       => __( 'Auto content text before image post (first paragraph)', ktz_theme_textdomain ),
        'id'          => 'ktz_wall_autocontent_firstp',
        'type'        => 'textarea',
        'desc'        => __( 'Auto content text, available filter: %ktzhomeurl%=home url, %ktzblogname%=blogname, %ktzblogdescription%=blog description, %ktzpermalink%=permalink, %ktztitle%=title, %ktzdate%=date, %ktzauthor%=author, %ktzcategory%=category, %ktzblogname%=tag list, %ktzview%=Number view post, %ktzpostformat%=Post format', ktz_theme_textdomain ),
        'std'         => '%ktztitle% is free HD wallpaper. This wallpaper was upload at %ktzdate% upload by %ktzauthor% in %ktzcategory%.',
        'rows'        => '10',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
		'condition'   => 'ktz_active_autocontent:is(yes),ktz_active_autocontent:not()',
        'section'     => 'other_tab'
      ),
      array(
        'label'       => __( 'Auto content text after image post (second paragraph)', ktz_theme_textdomain ),
        'id'          => 'ktz_wall_autocontent',
        'type'        => 'textarea',
        'desc'        => __( 'Auto content text, available filter: %ktzhomeurl%=home url, %ktzblogname%=blogname, %ktzblogdescription%=blog description, %ktzpermalink%=permalink, %ktztitle%=title, %ktzdate%=date, %ktzauthor%=author, %ktzcategory%=category, %ktzblogname%=tag list, %ktzview%=Number view post, %ktzpostformat%=Post format', ktz_theme_textdomain ),
        'std'         => 'You can download %ktztitle% in your computer by clicking resolution image in Download by size:. Don\'t forget to rate and comment if you interest with this wallpaper.',
        'rows'        => '10',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
      ...
      array(
        'label'       => __( 'Auto content text third paragraph only in attachment', ktz_theme_textdomain ),
        'id'          => 'ktz_wall_autocontent_threep',
        'type'        => 'textarea',
        'desc'        => __( 'Auto content text, available filter: %ktzhomeurl%=home url, %ktzblogname%=blogname, %ktzblogdescription%=blog description, %ktzpermalink%=permalink, %ktztitle%=title, %ktzdate%=date, %ktzauthor%=author, %ktzcategory%=category, %ktzblogname%=tag list, %ktzview%=Number view post, %ktzpostformat%=Post format', ktz_theme_textdomain ),
        'std'         => 'This is third paragraph auto content for attahcment title: %ktztitle%. You can make unique content for attachment but automatic and easy.',
        'rows'        => '10',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
