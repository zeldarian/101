...
function _custom_meta_boxes() {
  ...
  $general_page = array(
    ...
    'fields'      => array(
      ...
      array(
        'label'       => __( 'Enable breaking news slide for this post?', ktz_theme_textdomain ),
        'id'          => 'ktz_activated_breaking',
        'type'        => 'radio',
        'desc'        => __( 'Please check yes for enable breaking news slide for this post and check no for disable breaking news slide for this post.', ktz_theme_textdomain ),
        'choices'     => array(
          array (
            'label'       => 'Yes',
            'value'       => 'yes'
      ...
      array(
        ...
        'id'          => 'ktz_textblock',
        'type'        => 'textblock',
        'desc'        => __( 'For more information, if you use SEO plugin like yoast or AIO, please disable kentooz SEO, you can disable it via theme option -> SEO and leave blank this options.' ),
      ),
      array(
      ...
      array(
        ...
        'id'          => 'ktz_textblock',
        'type'        => 'textblock',
        'desc'        => __( 'For information, this is for custom page squeeze page look page atribute in right sidebar change template to squeeze and you can setting squeeze page here. Look this image: http://prntscr.com/3t3zm5 or read this tutorial for page attribute: http://en.support.wordpress.com/pages/page-attributes/' ),
      ),
      array(
  ...
  $general_post = array(
    ...
    'fields'      => array(
      ...
      array(
        'label'       => __( 'Link', 'option-tree-theme' ),
      ...
      array(
        ...
        'type'        => 'text',
        'desc'        => 'Fill this with dailymotion URL video for example link: http://www.dailymotion.com/video/xt191t_compilation-34-party-fails_fun fill with full url http://www.dailymotion.com/video/xt191t_compilation-34-party-fails_fun, leave blank all field in video option if you use vimeo video.',
        'std'         => '',
      ),
      array(
        ...
        'type'        => 'upload',
        'desc'        => 'Please upload your MP4 video here, and fill field this input, or please insert link with example link:http://www.example.com/video-format.mp4. Support video: MP4 format.',
        'std'         => '',
      ),
      array(
        ...
        'type'        => 'upload',
        'desc'        => 'Please upload your webm video here, and fill field this input, or please insert link with example link:http://www.example.com/video-format.webm. Support video: webm format.',
        'std'         => '',
      ),
      array(
        ...
        'type'        => 'upload',
        'desc'        => 'Please upload your ogg video here, and fill field this input, or please insert link with example link:http://www.example.com/video-format.ogv. Support video: ogg format.',
        'std'         => '',
      ),
      array(
        'label'       => 'Other source',
