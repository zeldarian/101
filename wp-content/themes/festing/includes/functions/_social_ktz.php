...
*******************************************/
if ( !function_exists('ktz_share_cat') ) :
function ktz_share_cat() { 
	...
	echo '<li><a href="http://www.facebook.com/sharer/sharer.php?u=' . $permalink . '&amp;t=' . $title . '" target="_blank" class="ktz-facebook" title="Share This On facebook"><span class="fontawesome ktzfo-facebook"></span> Facebook</a></li>';
	echo '<li><a href="http://twitter.com/home?status=' . $title . '%20-%20' . $permalink . '" target="_blank" class="ktz-twitter" title="Share This On twitter"><span class="fontawesome ktzfo-twitter"></span> Twitter</a></li>';
	echo '<li><a href="http://pinterest.com/pin/create/button/?url=' . $permalink . '&amp;media=' . $img_featured . '&amp;description=' . $excerpt . '" class="ktz-pinterest" target="_blank" title="Share This On pinterest"><span class="fontawesome ktzfo-pinterest"></span> Pin it</a></li>';
    echo '<li class="dropdown">';
		echo '<a href="#" class="dropdown-toggle ktz-dropdown js-activated" data-toggle="dropdown">';
        echo '...';
		echo '</a>';
        echo '<ul role="menu" class="dropdown-menu">';
			echo '<li><a href="https://plus.google.com/share?url='. $permalink .'" class="ktz-gplus" target="_blank" title="Share This On google plus">Google Plus</a></li>';
			echo '<li><a href="http://www.digg.com/submit?url='. $permalink .'" class="ktz-digg" target="_blank" title="Share This On Digg">Digg</a></li>';
			echo '<li><a href="http://reddit.com/submit?url='. $permalink .'&title=' . $title . '" class="ktz-reddit" target="_blank" title="Share This On Reddit">Reddit</a></li>';
			echo '<li><a href="http://www.linkedin.com/shareArticle?mini=true&url='. $permalink .'" class="ktz-linkedin" target="_blank" title="Share This On Linkedin">Linkedin</a></li>';
			echo '<li><a href="http://www.stumbleupon.com/submit?url='. $permalink .'&title=' . $title . '" class="ktz-stumbleupon" target="_blank" title="Share This On Stumbleupon">Stumbleupon</a></li>';
			echo '<li><a href="http://delicious.com/post?url=' . $permalink . '&amp;title=' . $title . '&amp;notes=' . $excerpt . '" target="_blank" class="ktz-delicious" title="Share This On delicious">Delicious</a></li>';	
	...
	echo '<li><a href="' . $permalink . '" class="ktz-readmore" title="Permalink to ' . get_the_title() . '">Read More</a></li>';
	echo '</ul>';
	} 
endif;
