...
* Add filter add_filter( 'get_avatar', 'ktz_avatar_css' );
* @ init.php
*/
...
/**
 * Change widget tag cloud inline style to CSS classes.
 *
 * @param  string $args
 * @return string
 */
...
* Add action template redirect add_action( 'template_redirect', 'ktz_search_pretty_permalinks' ); in init.php 
*/
...
* Add action after set theme API add_action('after_setup_theme', 'ktz_setup' ); in init.php 
*/
