...
class ktz_banner extends WP_Widget {
	function ktz_banner() {
		...
		$this->WP_Widget( 'ktz-banner', __( 'KTZ Banner',ktz_theme_textdomain ), $widget_ops );
	}
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 'banners' => '<a href="http://kentooz.com" title="example banner link"><img src="https://farm6.staticflickr.com/5572/14681915051_0bf4684147_o.png" alt="example banner" title="example banner" width="160" height="600"/></a>') );
