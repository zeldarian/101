...
class ktz_feedburner extends WP_Widget {
	function ktz_feedburner() {
		...
		$this->WP_Widget( 'ktz-feedburner', __( 'KTZ Social Feed',ktz_theme_textdomain ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		/* Start output */
			...
			echo '<form role="form" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open(\'http://feedburner.google.com/fb/a/mailverify?uri='.$feedburnerid.'\', \'popupwindow\', \'scrollbars=yes,width=550,height=520\');return true">';
