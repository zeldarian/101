...
function sitemap( $atts, $content = null ) {
	...
	$out .='<h4 class="widget-title"><span class="ktz-blocktitle">' . __('Pages',ktz_theme_textdomain) . '</span></h4><ul>';
	ob_start(); // fix list in sitemap
	$out .='' . wp_list_pages('title_li=');
	$out .= ob_get_contents();
	ob_end_clean();
    $out .='</ul><h4 class="widget-title"><span class="ktz-blocktitle">' . __('Categories',ktz_theme_textdomain) . '</span></h4><ul>';
	ob_start(); // fix list in sitemap
    $out .= wp_list_categories('title_li=');
	$out .= ob_get_contents();
	ob_end_clean();
    $out .='</ul><h4 class="widget-title"><span class="ktz-blocktitle">' . __('Archives',ktz_theme_textdomain) . '</span></h4><ul>';
	ob_start(); // fix list in sitemap
	...
	$cats = get_categories();
		...
		$out .='<h4 class="widget-title"><span class="ktz-blocktitle">' . $cat->cat_name . '</span></h4>';
		$out .='<ul>';
