...
get_header(); ?>
	...
	<section class="col-md-12">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div class="ktz-single-box"><div class="entry-body">
				...
				<div class="entry-content clearfix">
					...
					<?php echo ktz_content_single_threep_attachement(); ?>
					<?php 
		...
		<?php ktz_attachment_banner(); ?>
		<?php if ( ot_get_option('ktz_active_download') == 'yes' ) {
			echo ktz_get_dl_image_single();
		} ?>
				<div id="fb-root"></div>
				<div class="wrapcomment">
					<div class="fb-comments" data-href="<?php the_permalink(); ?>" data-width="728" data-numposts="5" data-colorscheme="light"></div> 
				</div>
			</div></div>
